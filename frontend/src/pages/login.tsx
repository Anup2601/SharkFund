            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              >
                ...
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path
                    d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.762 2.239 5 5 5h14c2.762 0 5-2.238 5-5v-14c0-2.761-2.238-5-5-5zm-11.75 20h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.785-1.75-1.75s.784-1.75 1.75-1.75 1.75.785 1.75 1.75-.784 1.75-1.75 1.75zm13.25 12.268h-3v-5.604c0-1.337-.027-3.063-1.867-3.063-1.867 0-2.153 1.46-2.153 2.967v5.7h-3v-11h2.882v1.507h.041c.401-.76 1.379-1.563 2.837-1.563 3.032 0 3.594 1.996 3.594 4.59v6.466z"
                    fill="#ffffff"
                  />
                </svg>
              </button>
